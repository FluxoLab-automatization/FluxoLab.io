...
exports.WorkflowNodesService = void 0;
const common_1 = require("@nestjs/common");
let WorkflowNodesService = class WorkflowNodesService {
    nodeTemplates = [
        {
            id: 'ai-agent',
            name: 'AI Agent',
    ...
    async getNodeConfigSchema(nodeType) {
    ...
    async validateNode(nodeData) {
        ...
        if (template) {
            const requiredFields = Object.keys(template.configSchema.properties).filter(key => template.configSchema.required?.includes(key));
...
exports.WorkflowNodesService = WorkflowNodesService;
exports.WorkflowNodesService = WorkflowNodesService = __decorate([
    (0, common_1.Injectable)()
], WorkflowNodesService);
//# sourceMappingURL=workflow-nodes.service.js.map